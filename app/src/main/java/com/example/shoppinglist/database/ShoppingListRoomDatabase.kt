...
abstract class ShoppingListRoomDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var shoppingListRoomDBINstance: ShoppingListRoomDatabase? = null

        fun getDatabase(context: Context): ShoppingListRoomDatabase? {
            if (shoppingListRoomDBINstance == null) {
                synchronized(ShoppingListRoomDatabase::class.java) {
                    if (shoppingListRoomDBINstance == null) {
                        shoppingListRoomDBINstance =
            ...
            return shoppingListRoomDBINstance
        }
    }
